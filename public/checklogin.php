<?php
    /*
     * daloradius - Web Management Interface for FreeRADIUS
     ...
     *
     ************************************************************************************
     * $Id: checklogin.php 143 2009-06-22 19:31:07Z liran $
     ************************************************************************************/
    ...
    function session_verify() {
        ...
        // Corrected for PHP 8+ by using string concatenation (.) instead of arithmetic (+) and ensuring clear comparison
        $string1 = substr(md5($REMOTE_ADDR), 0, 10) . substr(session_id(), 0, 1);
        $string2 = substr(session_id(), 1, 10) . substr(session_id(), 0, 1);
